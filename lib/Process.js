						...
						for (let i = 0; i < 3; i += 1) {
							...
							if (i === 0){
								...
								if (parseFloat(_balances).toFixed(8) >= (parseFloat(budgets)-1)){
									...
									marketoldx = orders[1].market.split('/');
									...
									if (i < 5){
										...
										console.log("\t ->(OrderID | " + orderIdnew + " | " + orders[i].market.replace('/', '') + " | " + price + ")")
										while (true) {
											...
											if(ckStatus) {
												...
												if (i === 2){
													binance.marketSell(orders[i].market.replace('/', ''), Math.floor(amountstart));
													i = 8
													break
												}										
									...
									binance.marketSell(orders[i].market.replace('/', ''), Math.floor(amount));
									i = 8
								}
							}																															
						}
